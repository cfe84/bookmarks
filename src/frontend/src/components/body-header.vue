<template>
    <div id="div-title" class="w3-bar w3-theme-d2">
        ...
        <div class="w3-bar-item w3-right w3-half"><span class="w3-button" v-on:click="openSettings"><i class="fa fa-cog"></i></span>
          | <i class="fa fa-user"></i> <span>{{context.user.name}}</span></div>
    </div>
</template>
